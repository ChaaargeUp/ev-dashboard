        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Set a default departure time for the ChaaargeUp Smart Charging`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Disabled in ChaaargeUp Smart Charging the check of the three phases Car on single phase Charging Station`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Added a minimum of 3 schedules when building the Charging Profiles with ChaaargeUp Smart Charging`,
        ...
        componentChanges: [
          {
            name: 'Dashboard',
            changes: [
              `Limit the max power of the 'safe' car to the power of the connector in the ChaaargeUp Smart Charging`,
              `Auto-detect single phase Car in ChaaargeUp Smart Charging using new Meter Values per phase`,
              `Implemented EV-Ready minimal amperage of 13A per phase in Static Limitation and ChaaargeUp Smart Charging`,
              `Excluded Suspended EV from the ChaaargeUp Smart Charging`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Send all the Charging Plan schedules provided by the ChaaargeUp Smart Charging to the Charging Station (remove limit of 3 Schedules max)`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Use unique ID to build the tree fuse for the ChaaargeUp Smart Charging service`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Added single phase charging station handling with the ChaaargeUp Smart Charging`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `Fixed ChaaargeUp Smart Charging root fuses not correctly provided`,
        ...
        componentChanges: [
          {
            ...
            changes: [
              ...
              `ChaaargeUp Smart Charging implementation`,
